...
const TaskPage = () => {
  ...
  return (
    <MainLayouts>
      {/* 1. Hapus padding horizontal (px) di sini karena sudah dihandle oleh MainLayouts untuk desktop */}
      <div className="min-h-screen font-sans text-slate-900 w-full flex flex-col py-2 md:py-8 pb-24 md:pb-8 px-2 md:px-0">
        {/* 2. HAPUS max-w-6xl dan biarkan w-full */}
        <div className="w-full flex-1 flex flex-col pb-2 md:pb-0">
          <div className="flex flex-row justify-between items-center mb-2 md:mb-10 px-2 md:px-0 shrink-0">
            ...
            <div className="flex gap-2 md:gap-4">
              <button
                onClick={() => openModal()}
                className="bg-indigo-600 hover:bg-indigo-700 text-white px-3 md:px-5 py-1.5 md:py-2.5 rounded-lg md:rounded-xl font-bold shadow-lg transition active:scale-95 text-xs md:text-base"
              >
                + Tugas
              </button>
              <button
                onClick={() => gooeyToast.success("Saved!")}
                className="bg-emerald-500 hover:bg-emerald-600 text-white px-3 md:px-5 py-1.5 md:py-2.5 rounded-lg md:rounded-xl font-bold shadow-lg transition active:scale-95 text-xs md:text-base hidden sm:block"
              >
                Save
              </button>
            </div>
