      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="bg-white rounded-[2.5rem] w-full max-w-md shadow-2xl relative z-10 overflow-hidden flex flex-col font-sans min-h-[500px]"
          >
            <AnimatePresence>
              {isImporting && (
                <motion.div
            ...
            <div className="px-8 pt-10 pb-6 text-center">
              ...
              <button
                ...
                className="mt-4 text-[#007BFF] text-xs font-bold flex items-center justify-center gap-2 mx-auto hover:bg-blue-100 bg-blue-50 px-5 py-2.5 rounded-full transition-all active:scale-95"
              >
                <FiUploadCloud size={16} /> Pulihkan Data dari JSON
              </button>
            </div>
